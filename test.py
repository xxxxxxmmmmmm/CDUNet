...
if __name__ == "__main__":
    ...
    # parser.add_argument('--data_path', type=str, default='E:\ct-dicom')
    # parser.add_argument('--saved_path', type=str, default='./npy_img2/')
    parser.add_argument('--data_path', type=str, default='E:\D45_3mm')
    parser.add_argument('--saved_path', type=str, default='./npy_D45/')
    ...
    parser.add_argument('--test_iters', type=int, default=43000)
