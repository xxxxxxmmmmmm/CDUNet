...
class ct_dataset(Dataset):
    def __init__(self, mode, load_mode, saved_path, test_patient, patch_n=None, patch_size=None, transform=None):
        ...
        #从 saved_path 文件夹下查找所有以 _input.npy 作为后缀的文件 返回他们的完整路径列表 并按字母顺序进行排序 赋值给变量 input_path
...
def get_loader(mode='train', load_mode=0,
               saved_path='./npy_img2/', test_patient='L056',
               patch_n=10, patch_size=64,
               transform=None, batch_size=8, num_workers=6):
